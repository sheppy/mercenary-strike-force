...
BootState = (function(_super) {
  ...
  BootState.prototype.debugMenu = function() {
    ...
    statesFolder.open();
    stateControl = statesFolder.add(StateManager, "currentState", ["menu", "demo1", "LoadMapDemo", "MoveMapDemo", "MoveMapSmoothDemo"]);
...
},{"../../../../vendor/iki-engine/src/Manager/EntityManager.coffee":14,"../../../../vendor/iki-engine/src/State.coffee":19,"./Demo1System.coffee":3}],3:[function(require,module,exports){
...
MoveMapSmoothDemoState = (function(_super) {
  ...
  MoveMapSmoothDemoState.prototype.init = function() {
    ...
    this.viewportEntity = EntityManager.createEntity("viewport");
  ...
  MoveMapSmoothDemoState.prototype.deactivate = function() {
    return EntityManager.removeEntity(this.viewport);
  };
